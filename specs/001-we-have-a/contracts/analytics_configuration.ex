defmodule WhoThere.AnalyticsConfiguration do
  @moduledoc """
      ...
      change fn changeset, _opts ->
        ...
        case validate_exclude_patterns(patterns) do
          ...
          {:error, invalid_pattern} ->
            Ash.Changeset.add_error(changeset, :exclude_patterns,
  ...
  validations do
    ...
    validate numericality(:session_timeout_minutes,
      greater_than: 0,
    ...
    validate numericality(:data_retention_days,
      greater_than: 0,
    ...
    validate fn changeset, _context ->
      case Ash.Changeset.get_attribute(changeset, :exclude_patterns) do
        ...
        patterns when is_list(patterns) ->
          case validate_exclude_patterns(patterns) do
            :ok -> :ok
            {:error, invalid_pattern} -> {:error, field: :exclude_patterns, message: "Invalid pattern: #{invalid_pattern}"}
          end
